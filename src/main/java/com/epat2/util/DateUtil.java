...
String[] currentYearWeekDate = getCurrentYearMonthDate(TimeZone.getDefault());

        System.out.println(currentYearWeekDate[0]);
        System.out.println(currentYearWeekDate[1]);
        System.out.println(currentYearWeekDate[2]);
...
/*        wk = ca1.get(Calendar.DAY_OF_WEEK);
    ...
    public static String[] getCurrentYearMonthDate(TimeZone tz){
    ...
    public static Integer getCurrentYear(TimeZone tz){
        ...
        return ca1.getWeekYear();

    }
    public static Integer getCurrentMonth(TimeZone tz){
